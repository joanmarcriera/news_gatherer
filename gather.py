...
if not os.path.exists('logs'):
    os.mkdir('logs')
log_file_handler = logging.handlers.TimedRotatingFileHandler('logs/args.log',
                                                             when='M',
                                                             interval=2)
...
parser.add_argument("-w",
                    ...
                    "Catalan,catalan,Ponsati,jailed learders,Ponsatí,"
                    "Artur Mas,CDR,Independence,independence,Trapero,"
                    "Separatist,separatist,Catalunya,cataluna",
